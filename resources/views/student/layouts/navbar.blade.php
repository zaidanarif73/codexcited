    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="index.html" class="nav-item nav-link active">Actvity</a>
                <a href="about.html" class="nav-item nav-link">Tentang</a>
                <a href="courses.html" class="nav-item nav-link">Materi</a>
                <a href="contact.html" class="nav-item nav-link">Leaderboard</a>
            </div>
            <a href="{{ route('auth.login.index') }}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block"><i class='bx bx-md bx-log-out'></i></a>
        </div>
    </nav>
    <!-- Navbar End -->