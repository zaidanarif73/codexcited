...
@section("title","Dashboard ~ CODEXCITED")
@section("title_breadcumb","Dashboard")
@section('css')
    <link rel="stylesheet" href="{{URL::to('/')}}/assets/teacher/css/clock.css">
@endsection
...
<div class="row m-5">
    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="d-flex justify-content-center mb-3">
            @include('teacher.components.clock')
        </div> 
    </div>
    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
...
@section('script')
    <script src="{{URL::to('/')}}/assets/teacher/js/plugins/clock/clock.js"></script>
